cordova.define("iBeacon.iBeacon", function(require, exports, module) { var exec = require('cordova/exec');
...
iBeacon.prototype.startRangingBeaconsInRegion = function (successCallback) {
    if (typeof successCallback !== "function") {
        console.error("iBeacon.startRangingBeaconsInRegion failure: success callback parameter must be a function");
        return;
    }
