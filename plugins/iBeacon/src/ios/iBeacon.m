...
// @interface iBeacon () <CLLocationManagerDelegate>
...
- (iBeacon*)pluginInit
{
    self.defaultProximityUUID = self.proximityUUIDs[0];
    self.defaultPower = @-59;

    // self.locationManager = [[CLLocationManager alloc] init];
    // self.locationManager.delegate = self;
   
    // CLBeaconRegion *self.currentRegion = [[CLBeaconRegion alloc] initWithProximityUUID:uuid identifier:[self.defaultProximityUUID UUIDString]];
...
//     // start ranging
//     // CLBeaconRegion *region = [[CLBeaconRegion alloc] initWithProximityUUID:uuid identifier:[defaultProximityUUID UUIDString]];
	
//     [self.locationManager startRangingBeaconsInRegion:self.currentRegion];
